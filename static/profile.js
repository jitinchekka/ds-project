...
Cluster.innerHTML =
  '<button type="button" class="btn btn-primary btn-lg"><i class="bi bi-arrow-left"></i>Clustering</button>';
...
nextPage.append(pca);
pca.innerHTML =
  '<button type="button" class="btn btn-primary btn-lg"><i class="bi bi-arrow-left"></i>PCA</button>';
