...
def success():
	if request.method=='POST':
		...
		with open("templates/profile.html", "rb+") as f:
			lines = f.readlines()
			# Add <script> tag to the HTML file at the end to load the JS file
			lines.insert(-1, "<script src='/static/profile.js'></script>")	
